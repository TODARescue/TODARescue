...
<body class="bg-white d-flex justify-content-center align-items-start min-vh-100 pt-5">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="me-3">
                                    <?php if (!empty($row['photo']) && file_exists($photoPath)) { ?>
                                        <img src="<?php echo $photoPath; ?>" alt="Passenger Photo" class="rounded-circle"
    ...
    <script>
        function goToPassengerView(userId) {
            window.location.href = "passengersView.php?userId=" + userId;
        }
