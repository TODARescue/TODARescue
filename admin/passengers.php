...
<body class="bg-white d-flex justify-content-center align-items-start min-vh-100 pt-5">
            ...
            <div class="card border-0 clickable-card"
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                        ...
                        <span class="text-dark">User 1</span>
                    </div>
                    <div class="d-flex gap-2">
                        <a href="editProfilePassenger.php" class="btn btn-info btn-sm rounded-circle text-white"
    ...
    <script>
        function goToPassengerView(event) {
            window.location.href = "passengersView.php";
        }
    </script>
