...
<head>
  ...
  <title>TODA Rescue - Edit Account</title>
    ...
    <div class="row h-100 g-0">
      <div class="col-12 d-flex justify-content-center align-items-start h-100">
        <div class="card bg-white w-100 h-100 d-flex flex-column p-0"
          ...
          <div class="d-flex flex-column align-items-center justify-content-start px-4 pb-5 overflow-auto"
            ...
            <form class="w-100" method="POST">
              <div class="d-flex flex-column align-items-start mb-3">
                ...
                <input type="text" name="firstName"
                  ...
                  style="border-bottom: 2px solid #000;" value="<?= htmlspecialchars($user['firstName']) ?>" required />
              </div>

              <div class="mb-3">
                <label class="form-label text-muted small fw-bold">Last Name</label>
                <input type="text" name="lastName" class="form-control border-0 border-bottom rounded-0 shadow-none p-0"
              ...
              <div class="mb-3">
                ...
                <input type="text" name="contactNumber"
                  class="form-control border-0 border-bottom rounded-0 shadow-none text-start p-0"
                  value="<?= htmlspecialchars($user['contactNumber']) ?>" required />
              </div>
