...
<div class="container-fluid position-fixed bottom-0 start-0 end-0 z-1 px-0 d-xl-none bg-white">
    <div class="row custom-navbar g-0 m-0">
        <div class="col col-navbar text-center" data-icon="home">
            <a href="../passenger/index.php" class="d-flex flex-column justify-content-center align-items-center py-2 w-100 h-100">
        ...
        <div class="col col-navbar text-center" data-icon="circle">
            <a href="../passenger/scanQr.php" class="d-flex flex-column justify-content-center align-items-center py-2 w-100 h-100">
        ...
        <div class="col col-navbar text-center" data-icon="phone">
            <a href="../passenger/emergencyContact.php" class="d-flex flex-column justify-content-center align-items-center py-2 w-100 h-100">
        ...
        <div class="col col-navbar text-center" data-icon="settings">
            <a href="../passenger/settings.php" class="d-flex flex-column justify-content-center align-items-center py-2 w-100 h-100">
