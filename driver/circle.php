...
<head>
    ...
    <title>Driver | Circle Management</title>
                    ...
                    <div style="padding-top: 100px;">
                        <div class="p-4">
                            ...
                            <div class="d-flex justify-content-center pt-2 pb-0 mt-4 mb-0 gap-4">
                                <a href="../driver/createCircle.php"><button class="btn btn-sm rounded-pill px-4" style="background-color: #dcdcdc;">Create Circle</button></a>
                                <a href="../driver/joinCircle.php"><button class="btn btn-sm rounded-pill px-4" style="background-color: #dcdcdc;">Join Circle</button></a>
                            </div>
                        </div>
                    </div>
