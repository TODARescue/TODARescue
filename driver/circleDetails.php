...
<head>
    ...
    <title>Driver | Circle Details</title>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content bg-white p-4 rounded-5 shadow text-center border-0"
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        ...
                        <a href="../driver/leaveCircleAction.php?circleId=<?php echo $circleId; ?>" id="leaveCircleBtn" class="btn rounded-pill px-4 text-white"
